...
![不支持Disqus.jpg](https://images.hakurei.red/fkE8JSxeo4pjmu7.jpg)
...
![gitalk块配置](https://images.hakurei.red/jPw6frglHAW52ME.jpg)

到这里，理论上你基本就能看到和gitalk官网上一样的效果了。

然而，坑爹的事情不会就此停止，如果你在本地`hexo s`，然后打开一篇文章，你应该确实会看到“Gitalk加载中”，然后 * 噔  噔  咚 * ，出现了这样的场景：

![未找到相关的Issues](https://images.hakurei.red/VmbrWfpDMNute5O.jpg)
...
![gitalk在站点上](https://images.hakurei.red/62GCSo1yZp3ixRW.jpg)

而这是repo里对应的issue：

![gitalk在issue中](https://images.hakurei.red/l7pDt8vaf1gKdmk.jpg)
...
![默认配色](https://images.hakurei.red/mjACFTl8et5hfwp.jpg)
既然如此，我们去Gitalk的repo，找找这个色号出现在哪些地方。

![repo中的位置](https://images.hakurei.red/EAkaJT7sGz8jcC1.jpg)
...
![浅葱](https://images.hakurei.red/rzUKvqA5SIT7tPG.jpg)

这套色彩也是锤子的坚果手机“文青版”那几个骚气配色名称：远州鼠、落栗、苏芳、石竹、枯草、柳煤竹茶、锖青磁、鸠羽紫的来源。

![坚果手机文青版](https://images.hakurei.red/7p1J9MOtAChDqyi.jpg)

当然，这还不算完，我们得让NexT主题用上我们修改过的`gitalk.css`。

我们可以在next文件夹里搜索gitalk，看看它是如何被加载的。

![gtalk搜索结果](https://images.hakurei.red/UiRWDco3Tr6IAls.jpg)
...
![gitalk vendors](https://images.hakurei.red/FpBQKzJZhqjdtmY.jpg)
